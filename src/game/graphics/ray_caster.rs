...
pub fn cast_rays(tilemap: &Tilemap, camera: &Camera, maximal_distance: f32, total_columns: i32) {
    ...
    for column in 0..total_columns {
        ...
        cast_ray(tilemap, camera_position, ray_angle, maximal_distance);
    }
}
...
pub fn relative_ray_angle(column: i32, total_columns: i32) -> f32 {
